...
export default function AppFooter() {
  return (
    <footer className="border-t border-zinc-200 bg-white">
      <div className="mx-auto flex max-w-[1440px] flex-col gap-2 px-4 pt-4 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] text-xs text-zinc-500 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:pb-4">
